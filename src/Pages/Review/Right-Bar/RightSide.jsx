...
const RightSide = () => {
    return (
        ...
        <div>
            <iframe width="398" height="224" className='mb-4' src="https://www.youtube.com/embed/Qv31m3tQlVo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
